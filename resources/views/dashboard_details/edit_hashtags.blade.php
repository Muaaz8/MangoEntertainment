...
@section('content')
    <div class="tab-pane fade show active" id="v-pills-hashtag" role="tabpanel" aria-labelledby="v-pills-profile-tab">
        <div class="hashtag-edit" id="div2">
            <form action="{{ url('update/hashtags') }}" method="POST">
                @csrf
                <div class="hte-1 mb-4" onclick="history.back()">
                    <p>Edit Hashtag</p><span><img src="./img/close-icon.png" alt=""></span>
                </div>
                <input type="hidden" name="objectId" value="{{ $hashtags[0]->getObjectId() }}">
